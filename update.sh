...
function gitCommitAndPush {
	...
	APPLICATION_VERSION_MAJOR=$(echo ${DOCKER_IMAGE_TAG} | cut -d "." -f 1)
	APPLICATION_VERSION_MINOR=$(echo ${DOCKER_IMAGE_TAG} | cut -d "." -f 2)
	APPLICATION_VERSION_PATCH=$(echo ${DOCKER_IMAGE_TAG} | cut -d "." -f 3)
